...
REPORT_SCHEMA = "asecli.sg-conversion-report.v1"
MAPPING_VERSION = 2
...
def report_template(source: Path, target: Path, version: str, text: str) -> dict[str, Any]:
    empty = status("not_run", "not run")
    return {
        "schema": REPORT_SCHEMA,
        "exporter": {"name": "asecli", "version": __version__},
        "source": {"path": str(source), "sha256": hashlib.sha256(text.encode()).hexdigest(), "ase_version": version},
        "target_environment": {"project": str(target), "doctor": None},
        "mapping_version": MAPPING_VERSION,
        "receiver_schema": {"name": "sgcli.native.v2", "path": None, "sha256": None},
