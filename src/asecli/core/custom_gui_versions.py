...
PROPERTY_METADATA_TAIL_GRAPH_VERSIONS = frozenset(("19602",))
...
def require_property_metadata_tail_version(graph: AseGraph) -> None:
    _require_graph_version(
        graph,
        PROPERTY_METADATA_TAIL_GRAPH_VERSIONS,
        "ASECLI property metadata",
    )
