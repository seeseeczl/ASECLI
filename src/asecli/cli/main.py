...
def build_parser() -> argparse.ArgumentParser:
    ...
    s = sub.add_parser("custom-gui", help="inspect or edit CustomEditor and ASECLI property metadata")
    s.add_argument("file")
    ...
    group.add_argument("--group", help="set ASECLIFoldout group title")
    group.add_argument("--clear-group", action="store_true")
    tooltip = s.add_mutually_exclusive_group()
    tooltip.add_argument("--tooltip", help="set ASECLITooltip text")
    tooltip.add_argument("--clear-tooltip", action="store_true")
    help_box = s.add_mutually_exclusive_group()
    help_box.add_argument("--help-box", help="set ASECLIHelpBox message")
    help_box.add_argument("--clear-help-box", action="store_true")
    s.add_argument("--add-attribute", action="append", help="expert: add/replace an ASECLI metadata value")
    s.add_argument("--remove-attribute", action="append", help="expert: remove an ASECLI metadata type")
    s.add_argument("--write", action="store_true")
    s.set_defaults(func=cmd_custom_gui)

    s = sub.add_parser("gui-support", help="inspect or install ASECLI material GUI support")
