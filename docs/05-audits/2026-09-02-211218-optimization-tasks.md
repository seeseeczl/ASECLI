...
P1 应该完成
- [ ] P1.1 在授权后完成 0.2.0 不可变发布 — 进行中：用户已授权 tag `v0.2.0` 与私有 GitHub Release；先提交当前契约后再用 CI artifact 发版
...
当前进展：
- 已完成：P1.3、P2.1、P2.2
- 正在做：P1.1 0.2.0 不可变发布
- 下一步：提交当前改动、等待 CI artifact、打 tag 并创建私有 Release
- 阻塞/风险：P1.2 缺少隔离 Editor 环境；发版后不得覆盖 v0.1.0
