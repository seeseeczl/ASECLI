...
| MOD-GUI-SUPPORT | src/asecli/bridge/gui_support.py; `_gui_project.py`; `_gui_resource_store.py`; `_gui_resource_upgrade.py`; gui_presentation.py; bridge/resources/asecli_material_gui.part*.cs.txt | FR-0009 CR-0009 CR-0010 CR-0011 CR-0014 BUG-0014 BUG-0015 BUG-0019 BUG-0020 | 唯一 ASECLI GUI 的固定路径安装、已知旧哈希备份/原子升级、未知冲突拒绝、技术 Tooltip、旧三标记读取兼容与 `asecli.inline-help.v1`；长中文窄宽换行与稳定默认值格式 | `inspect_gui_support`；`install_gui_support`；`ASECLI.MaterialGUI.ASECLIMaterialGUI` | Python 仅标准库；C# 仅 UnityEditor/UnityEngine；禁止依赖 ASE API |
