...
| MOD-CLI | src/asecli/cli | FR-0003 FR-0005 FR-0007 FR-0009 FR-0010 FR-0011 CR-0002 CR-0003 CR-0004 CR-0005 CR-0006 CR-0008 CR-0011 CR-0012 BUG-0004 BUG-0006 BUG-0008 BUG-0009 BUG-0017 | 15 个命令、单行 JSON、写入/信任组合根、create 后端路由、属性呈现门禁与版本化 CI 打包 | `asecli <command>` | 允许依赖 core/schema/check/bridge；只能使用公开 API |
