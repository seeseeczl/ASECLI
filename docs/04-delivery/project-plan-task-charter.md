...
| TASK-0044 | CR-0017 CR-0006 | 缩短普通改动与发布自动门禁并发布、安装 `v0.4.1` | 用户要求执行效率优化并推送/发布/本机安装；TASK-0043 | AGENTS.md；回归目录 checker；CI；MCP timeout；README/version；REL-0007 | 启动 Editor、截图、删除安全门禁、缩短真实工具执行上限、公开分发 | TASK-0043/long/2026-09-05 | REG-0048；全量；发布资产 SHA；本机安装/回滚 | 聚合漏收集、CI 失去目录覆盖、MCP tool 超时改变或安装失败即回滚 `v0.4.0` | 目录检查 0.58s；全量 16.16s；`259 passed, 3 skipped`；远端发布证据待回填 | 候选已验证，待发布 |
