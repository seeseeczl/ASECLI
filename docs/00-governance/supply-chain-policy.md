...
- CI 使用经官方 tag 核对、固定 commit 且原生声明 Node 24 的 GitHub Actions；`tools/check_ci_governance.py` 固定三项 allowlist，阻止 SHA/runtime 回退。artifact 同时上传 wheel、sdist、SHA256SUMS、SBOM 和供应链检查结果。
